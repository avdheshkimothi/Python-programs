...
if k==1:
   ...
   for i in range(length):
     passchar=chr(random.choice(list(range(65,91))+list(range(97,123))+list(range(48,58)))) #digits and letters
   ...
   list1=list()
   for i in range(length):
     passchar=chr(random.choice(list(range(65,91))+list(range(97,123)))) #characters only
     list1.append(passchar)
   password=''.join(list1)
   print("YOUR PASSWORD IS  : \n ",password)
elif k==4:
